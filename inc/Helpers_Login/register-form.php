<?php
/**
 * Form to display on login_form_register action
 *
 * @package  WordPress
 * @subpackage  Logger
 * @since   Logger 1.0
...
$form = '<div class="login-wrapper">
    ...
    <div class="login-wrapper__col">
        ...
        <a class="login__logo" href="' . esc_url( 'https://orbital.co.uk' ) . '">
        ...
        <p class="message">please fill out the form below and a registration confirmation will be emailed to you.</p>

        <form name="registerform" id="registerform" class="login-form" action="' . esc_url( $site_url . '/access?action=register' ) . '" method="post" novalidate="novalidate">
            <div class="login-form__field-wrap">
                <input type="text" name="user_login" id="user_login" class="login-form__input" size="20" autocapitalize="off" placeholder="Username" />
                <label class="login-form__label" for="user_login">username</label>
            </div>

            <div class="login-form__field-wrap">
                <input type="email" name="user_email" id="user_email" class="login-form__input" size="20" autocapitalize="off" placeholder="Email Address" />
                <label class="login-form__label" for="user_email">email</label>
            </div>

            <div class="form-split">
                <div class="submit">
                    <input type="submit" name="wp-submit" id="wp-submit" class="login-form__submit" value="register" />
                    <input type="hidden" name="redirect_to" value="" />
                </div>
            </div>
        </form>

        <a class="login-form__link" href="' . esc_url( $site_url . '/access?action=lostpassword' ) . '">forgotten your password?</a>
    </div>
</div>';
