<?php
/**
 * Form to display on login_form_lostpassword action
 *
 * @package  WordPress
 * @subpackage  Logger
 * @since   Logger 1.0
...
$form = '<div class="login-wrapper">
    ...
    <div class="login-wrapper__col">
        ...
        <p class="message">forgotten your password?</p>
        <p class="message">please enter your username or email address below to receive an email to set a new password.</p>
        <form name="lostpasswordform" id="lostpasswordform" class="login-form" action="' . esc_url( $site_url . '/access?action=lostpassword' ) . '" method="post">
            <div class="login-form__field-wrap">
                <input type="text" name="user_login" id="user_login" class="login-form__input" size="20" autocapitalize="off" placeholder="Username or Email Address" />
            ...
            <div class="form-split">
                ...
                <div class="submit">
                    <input type="submit" name="wp-submit" id="wp-submit" class="login-form__submit" value="get new password" />
                    <input type="hidden" name="redirect_to" value="" />
                </div>
            </div>
        </form>

        <a class="login-form__link" href="' . esc_url( $site_url . '/access' ) . '">know your password? log in</a>
    </div>
</div>
